...
public class TestLinkConnector {
	...
	private static void displayTestCases(Integer planId, Integer buildId) {
		...
		System.out.println();
		System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------");
		System.out.printf("%10s %30s %20s %50s", "TestCase ID", "TestCase NAME", "TestCase VERSION", "TestCase STEPS Actions");
		System.out.println();
		System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------");
		for (TestCase test : plugin.getTestCasesForTestPlan(planId, buildId)) {
			System.out.format("%10s %30s %20s %50s", test.getId(), test.getName(), test.getVersion(), test.getSteps().get(0).getActions());
			System.out.println();
		}
		System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------\n\n\n");
